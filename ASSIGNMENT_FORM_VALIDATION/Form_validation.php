...
<body>
    <?php
        ...
        function passValidation($pass){
            ...
            for($i=0;$i<$passlength;$i++){
                ...
                if($boolLower && $boolUpper && $boolSpecial && $boolNum){
                    return true;
                }
        ...
        if($_SERVER['REQUEST_METHOD']=='POST'){
            ...
            if(empty($_POST["pass"])){
                ...
                $err_password="*Password must contain upper, lower, a special character  and number";
            }
    ...
    <fieldset>
        ...
        <form action="" method="post">
            <table align="center">
                ...
                <tr>
						...
						<td><input type="checkbox" value="A friend or colleague" name="aboutus[]">A friend or colleague 
							 <br><input type="checkbox" value="Google" name="aboutus[]">Google 
							 <br><input type="checkbox" value="Blog Post" name="aboutus[]">Blog Post
                             <br><input type="checkbox" value="News Article" name="aboutus[]">News Article
                             <br><span> <?php  echo $err_aboutus ?> </span>
                        </td>
					</tr>
			...
			<input type="submit" name="submit" value="Register" style="margin-left:auto;margin-right:auto;display:block;margin-top:auto%;">
        </form>
